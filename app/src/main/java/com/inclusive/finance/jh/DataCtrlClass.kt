...
object DataCtrlClass {
    ...
    fun getSecurityCode(
        ...
        username: String,
        phone: String? = "",
        listener: (errorMsg: NetEntity<Boolean>?) -> Unit
    ) { //        phone	string	必填	手机号
     ...
     * @param[phone] string	必填	手机号
     * */
    fun verifySecurityCode(
        context: Context?,
        phone: String,
        code: String,
        listener: (it: NetEntity<Boolean>?) -> Unit
    ) { //        phone	string	必填	手机号
        //        purpose	string	必填	用途：1注册，2忘记密码，3设置支付密码
        val params = HashMap<String, String>()
        params["telephone"] = phone
    ...
    fun loginWechatApp(
        ...
        headUrl: String,
        listener: (userId: User?) -> Unit
    ) { //        user.wechatUnionid=$wechatUnionid&user.headUrl=$headUrl&user.deviceToken=$deviceToken&user.deviceType=$deviceType
        val params = HashMap<String, String>()
        params["wechatUnionid"] = wechatUnionid
        params["headUrl"] = headUrl.replace(
            "http://",
            "https://"
        ) //        params["deviceToken"] = PushAgent.getInstance(context).registrationId
        //        params["deviceType"] = "1"
        context?.let {
    ...
    fun saveUser(
        ...
        name: String,
        phone: String,
        listener: (it: NetEntity<Void>?) -> Unit
    ) { //       user.id=$userId&user.phone=$phone&user.name=$name
    ...
    object LoginNet {
        ...
        fun loginPwd(
            ...
            password: String,
            code: String,
            isForcibly: Boolean? = false,
            listener: (userId: User?) -> Unit
        ) {
            val params =
                HashMap<String, Any>() //            params["username"] = phone //            params["password"] = password
            params["loginData"] = RSAUtils.encryptByPublicKey("$phone#jdkj#$password#jdkj#$code")
            params["clientId"] =
                Settings.System.getString(context?.contentResolver, Settings.Secure.ANDROID_ID);
            params["remember_me"] =
                true //            params["deviceToken"] = PushAgent.getInstance(context).registrationId
            //            params["deviceType"] = "1"
         ...
         * 修改密码
         * */
        fun changePasswordForApp(
            context: Context?,
            id: String,
            username: String,
            password: String,
            rootView: View?,
            listener: (userId: String?) -> Unit
        ) {
            val params = HashMap<String, String>()
            params["id"] = id
            params["username"] = username
    ...
    object MainNet {
         ...
         * 获取获取首页待办事项
         */
        fun get_main_dbsx_list(
            context: Context?,
            listener: (it: ArrayList<JsonObject>?) -> Unit
                ...
                if (it.requireable && it.editable) if (!it.haveValue) {
                    if (context != null) {
                        SZWUtils.showSnakeBarMsg(
                            contentView,
                            "请补充" + if (it.keyName.isEmpty()) it.valueHint else it.keyName
                        )
                    }
                    return
                }
    ...
    object SXSQNet {
        ...
        fun searchQuery(
            ...
            query: String,
            key: String,
            listener: (it: ArrayList<String>?) -> Unit
        ) {
            val params = HashMap<String, String>()
            params["parm"] = key
            params["value"] = query
         ...
         *特殊模糊查询 行政机关
         */
        fun searchQuery_fzjg(
            context: Context?,
            query: String,
            listener: (it: ArrayList<DarkSearchPop.SearchBean>?) -> Unit
        ) {
            val params = HashMap<String, String>()
            params["name"] = query
            context?.let {
    ...
    object SXDCNet {
        ...
        fun getPJZB(
            ...
            url: String,
            keyId: String? = "",
            listener: (it: TargetBeanList?) -> Unit
        ) { //       orderId=$orderId&prePay =$prePay
            val params = HashMap<String, String>()
            params["creditId"] = keyId ?: ""
            params["ysxId"] = keyId ?: ""
        ...
        fun getSDDCList(
            ...
            keyId: String? = "",
            businessType: String? = "",
            listener: (it: NetEntity<ArrayList<SDDCBean>>?) -> Unit
        ) { //       orderId=$orderId&prePay =$prePay
            val params = HashMap<String, String>()
            if (jsonObject != null) params["bean"] = Gson().toJson(jsonObject)
            params["id"] = SZWUtils.getJsonObjectString(jsonObject, "id")
    ...
    object SXSPNet {
        ...
        fun getList_flowHis(
            ...
            type: String? = "",
            businessType: Int?,
            listener: (it: ArrayList<ProcessHistort>?) -> Unit
        ) { //       orderId=$orderId&prePay =$prePay
        ...
        fun getSXSPById(
            ...
            businessType: Int? = 0,
            type: String? = "",
            listener: (it: ConfigurationBean?) -> Unit
        ) { //       orderId=$orderId&prePay =$prePay
            val url = when (businessType) {
                ApplyModel.BUSINESS_TYPE_APPLY,
                ApplyModel.BUSINESS_TYPE_INVESTIGATE,
        ...
        fun saveSignSuggestion(
            ...
            businessType: Int? = 0,
            listener: (it: String?) -> Unit
        ) { //    String creditId, String suggestion, String annex
            val url = when (businessType) {
                ApplyModel.BUSINESS_TYPE_APPLY,
                ApplyModel.BUSINESS_TYPE_INVESTIGATE,
                ApplyModel.BUSINESS_TYPE_INVESTIGATE_SIMPLEMODE,
        ...
        fun saveZXSP(
            ...
            rootView: View,
            listener: (it: String?) -> Unit
        ) { //     入参：id(选择审批的数据id)  result:(同意传agree  不同意传reject)  comment:审批的意见
            val params = HashMap<String, String>()
            params["id"] = id
            params["ids"] = id
    ...
    object JNJNet {
        ...
        fun getJNJCJRWMC(
            context: Context?,
            listener: (it: ArrayList<BaseTypeBean.Enum12>?) -> Unit
        ) { //       orderId=$orderId&prePay =$prePay
            val params = HashMap<String, String>()
            context?.let {
                ...
                OkGo.post<String>(Urls.get_rc_batchFlag)
                    .tag(this).execute(object : StringCallback() {
                        override fun onSuccess(response: Response<String>?) {
                            ...
                            var bean = GsonUtils.fromJson<NetEntity<String>>(
                                response?.body(),
                                NetEntity::class.java
                            )
    ...
    object ApplyNet {
        ...
        */
        ...
        fun getKHInfoHyfl(
            ...
            type: Int,
            bean: BaseTypeBean,
            listener: (it: ArrayList<HangYeFenLeiBean>?) -> Unit
        ) { //       orderId=$orderId&prePay =$prePay
            val url = when (type) {
                BaseTypeBean.TYPE_8 -> {
                    Urls.khInfoCategory
         ...
         * 获取征信授权页面
         */
        fun getCreditAuthorizationInfo(
            context: Context?,
            url: String? = "",
            keyId: String? = "",
            json: String? = "",
         ...
         * 删除征信授权页面
         */
        fun deleteCreditAuthorizationInfo(
            context: Context?,
            url: String? = "",
            creditId: String? = "",
            json: String? = "",
        ...
        fun getJiaTing(
            ...
            keyId: String? = "",
            json: String? = "",
            listener: (it: ArrayList<JtxxBean>?) -> Unit
        ) { //       orderId=$orderId&prePay =$prePay
            val params = HashMap<String, String>()
            params["creditId"] = keyId ?: ""
            params["json"] = json ?: ""
        ...
        fun getRiskHFW(
            ...
            dhId: String? = "",
            businessType: String? = "",
            listener: (it: ArrayList<BaseTypeBean>?, msg: String?) -> Unit
        ) { //       orderId=$orderId&prePay =$prePay
            val params = HashMap<String, String>()
            params["creditId"] = creditId ?: ""
            params["json"] = json ?: ""
        ...
        */
        ...
        fun getApplyCheck(
            ...
            dhId: String? = "",
            zfId: String? = "",
            listener: (it: ComleteCheckBean?) -> Unit
        ) { //       orderId=$orderId&prePay =$prePay
            val params = HashMap<String, String>()
            params["creditId"] = creditId ?: ""
            params["dhId"] = dhId ?: ""
         ...
         * 获取担保人人脸识别信息
         * */
        fun getCreditManagerFace(
            context: Context?,
            url: String,
            keyId: String?,
            json: String?,
            listener: (faceBean: FaceBean?) -> Unit
        ) { //        creditId:
            //        id:
            val params = HashMap<String, String>()
            params["creditId"] = keyId ?: ""
...
//            type：edit
    ...
    object SystemManagerNet {
         ...
         * 请假审批
         */
        fun save_main_leaveApprove(
            context: Context?,
            id: String,
            approveRet: String,
            conclusion: String,
            listener: (it: String?) -> Unit
        ) { //  approveRet：审批结果(必传)     通过 | 否决
            //conclusion：审批意见
            val params = HashMap<String, String>()
            params["id"] = id
            params["approveRet"] = approveRet
    ...
    fun getshowCode(
        context: Context?,
        listener: (it: Boolean?) -> Unit
    ) { //       orderId=$orderId&prePay =$prePay
        val params =
            HashMap<String, String>() //        params["version"] = AppUtils.getAppVersionCode().toString() + ""
        context?.let {
    ...
    fun getMainMenuList(
        context: Context?,
        listener: (it: ArrayList<ItemMainAdapter.MainHeader>?) -> Unit
    ) { //       orderId=$orderId&prePay =$prePay
        val params = HashMap<String, String>()
        context?.let {
...
//        }
                ...
                .execute(object : FileCallback(appDir.absolutePath, appName) {
                    ...
                    override fun onError(response: Response<File>?) {
                        response?.message()?.toString()
                            ?.let { it1 -> SZWUtils.showSnakeBarError(it1) }
                        CustomProgress.disMiss()
                    }
    ...
    fun upDataOCR(
        ...
        file: File,
        rootView: View? = null,
        listener: (idCardBean: IDCardBean?) -> Unit
    ) {
        val params = HashMap<String, String>()
        params["side"] = side
        context?.let {
    ...
    fun uploadFiles(
        ...
        listener: (urls: ArrayList<PicBean>?) -> Unit
    ) {
        val params = HashMap<String, String>()
        params["creditId"] = keyId ?: ""
        params["dhId"] = keyId ?: ""
...
//            params["isOnline"] = isOnline
            ...
            context?.let {
                OkGo.post<NetEntity<ArrayList<BaseTypeBean>>>(Urls.get_sunCredit_listApp)
                    .params(params)
                    .tag(this).execute(object :
                        DialogCallback<NetEntity<ArrayList<BaseTypeBean>>>(it, false) {
                        override fun onSuccess(response: Response<NetEntity<ArrayList<BaseTypeBean>>>) {
